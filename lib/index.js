...
exports.Switch = react_router_1.Switch;
...
function ConnectedSwitch(props, _a) {
    ...
    return (React.createElement(react_router_1.Switch, __assign({ location: router.route.location }, props), props.children));
}
    ...
    return function (app) { return function (props) {
        return app(__assign({}, props, { init: function () {
                ...
                return [__assign({}, result[0], { location: history.location }), result[1]];
                    ...
                    } }, _a[CHANGE_LOCATION] = function (location) { return function (state) { return (__assign({}, state, { location: location })); }; }, _a)), view: function (state, actions) {
                var view = props.view(state, actions);
                return React.createElement(react_router_1.Router, { history: history }, view);
